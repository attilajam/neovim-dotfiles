...
function TypstOpenPdf()
	local fullPath = vim.fn.expand("%:p")
	local pdfFile = string.gsub(fullPath, "%.typ", "%.pdf")
	vim.fn.jobstart("zathura --fork " .. pdfFile .. " &")
end

vim.api.nvim_set_keymap("n", "<leader>op", ":lua TypstOpenPdf()<CR>", { silent = true })
